<template>
  <div class="max-w-4xl mx-auto space-y-24 py-16">
    <div
      ...
      style="
        background-image: url('https://img.freepik.com/free-photo/medium-shot-smiley-kid-sitting-outdoors_23-2148860402.jpg?ga=GA1.1.487577296.1727511220&semt=ais_hybrid');
        min-height: 300px;
      "
    >
